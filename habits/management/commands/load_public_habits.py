...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        user, created = User.objects.get_or_create(
            ...
            defaults={"email": "bot@habittracker.com", "is_active": True, "is_verified": True},
        )
        ...
        for data in pleasant_data:
            habit = Habit.objects.create(user=user, **data, is_public=True)
        ...
        for data in useful_data:
            ...
            habit_data = {"user": user, "is_pleasant": False, "is_public": True, "related_habit": None, "reward": None}
