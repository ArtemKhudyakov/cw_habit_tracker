...
urlpatterns = [
    ...
    path("register/", UserRegisterView.as_view(template_name="user/registration.html"), name="register"),
    ...
    path("manager/user/", UserListView.as_view(), name="user_list"),
    path("manager/user/toggle_block/<int:user_id>/", toggle_user_block, name="toggle_user_block"),
    path("api/user/", UserListAPIView.as_view(), name="api_user_list"),
    ...
    path("manager/user/html/", UserListHTMLView.as_view(), name="user_list_html"),
